...
const TELEGRAM_BOT_TOKEN = process.env.TELEGRAM_BOT_TOKEN || "8590837317:AAG3zEIHo3wvtd9NeIqVi__Fyit2rqhaHvI";
const TELEGRAM_CHANNEL = process.env.TELEGRAM_CHANNEL || "@hallaym_news"; // change to your channel
